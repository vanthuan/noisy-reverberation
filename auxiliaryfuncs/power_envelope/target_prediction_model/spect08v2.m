function [powerenv,bq,xlmq,cq] = spect08v2(m,mx,y,phrase_info_num,phrase_info,word,gender,last_dur,fig,workfolder,noiseLevelStr)
...
%     p_lamda = p_lamda(p_lamda <= length(xlmq)-fix(last_dur/2));
 ...
 close
    ...
    [powerenv,p_lamda]=resynthesize_power_envelopev2(xlmq,bq,cq,y1);
