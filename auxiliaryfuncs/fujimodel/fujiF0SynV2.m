function [f0syn,xhatNeutral] = fujiF0SynV2(f0rawContour,phrase_info_num)
...
%                     dynamicranges{1,ss}(ii-2,jj) = upApAa;
                    lb =[log(70) 0 -0.3 0 0];
                    ub = [mean(y) upApAa  0 upApAa length(f0rawContour)];
