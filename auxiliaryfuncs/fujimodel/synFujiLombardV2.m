function [f0Syn_Fujji_Lombard] =   synFujiLombardV2(xhatNeutral,f0raw_syn_dur,phrase_info_num,speaker,jj)
...
alpha = 6;
beta = 40;
[ yFb ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'Fb');
[ yAp ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'Ap');
[ yAa ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'Aa');
[ yF0dyn ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'F0 Dynamic');
[ yT0 ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'T0');
[ yT1 ] = mathematical_f0_fujiparamYINALLRefined20170612(60+ 6*(jj-1), speaker,'T1');
