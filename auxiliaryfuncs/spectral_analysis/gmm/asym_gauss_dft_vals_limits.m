...
%y: spectral envelope
function [y,m,v,w,r,max_amp] = asym_gauss_dft_vals_limits(f,x, M,limits,m_init,v_init,w_init,r_init,init_type,fft_m)
y=zeros(size(x));
i=1;
    max_amp=max(x(:,i));
    [m,v,w,r]=asym_gaussmix_his_vals_limits(f,x(:,i)',M,limits,m_init,v_init,w_init,r_init,init_type,100.00001,0,fft_m');
