function [mod_spec_gmm] = GMM_PHI_TOP_GAUSS_PHI(f0rawNeutral,maxMora,fs, GMM_M,GMM_V,GMM_W,GMM_MAX,OPT_PARA, pos, numsSmooth,changed,gauss_adds_up,gauss_moras,GMM_P, m_order,phrase_info,phrase_info_num,gender,freq_shifts,amp_scales, vowels, voiced_consonants)
...
%         end
        ...
        gmm_spectraEnv = gmm_spectraEnv.*gauss_adds_up{tt};
...
%                                 h4 = plot(((0:512)'/1024*fs),db(gmm_spectraEnv2),'linewidth',1.3);
