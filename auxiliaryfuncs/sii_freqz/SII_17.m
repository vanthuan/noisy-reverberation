...
N = N(:)'; T = T(:)'; E = E(:)';
if length(N) ~= 17, error('Equivalent Noise Spectrum Level: Vector size incorrect');                end;
if length(T) ~= 17, error('Equivalent Hearing Threshold Level: Vector size incorrect');             end;
if length(E) ~= 17, error('Equivalent Speech Spectrum Level: Vector size incorrect');               end;
