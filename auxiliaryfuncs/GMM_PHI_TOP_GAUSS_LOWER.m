function [mod_spec_gmm] = GMM_PHI_TOP_GAUSS_LOWER( A, pos,PL, numsSmooth,changed,gmm_param_up,increase_para_up,gmm_para_up_mora,increase_para_up_mora, P,GMM_P, m_order,phrase_info,phrase_info_num,f0rawNeutral,gender,freq_shifts,amp_scales, vowels, voiced_consonants)
