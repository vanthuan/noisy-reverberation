function [SYN_SE_MIMICS,mod_spec_gmm] = GMM_ENVSPS_TOP_GAUSS(PHI, A, pos,PL,gauss_addvvl, numsSmooth,changed,gmm_param_up,increase_para_up,gmm_para_up_mora,increase_para_up_mora, P,GMM_P, m_order,phrase_info,phrase_info_num,f0rawNeutralDur,f0raw,gender,freq_shifts,amp_scales, vowels, voiced_consonants)
